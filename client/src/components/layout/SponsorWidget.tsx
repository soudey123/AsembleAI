...
export function SponsorWidget() {
  return (
    <a
      ...
      className="sponsor-widget group fixed z-[60] flex h-12 w-12 items-center justify-center overflow-hidden rounded-full border border-cyan-300/30 bg-[#071225]/95 p-0 text-white backdrop-blur-xl sm:h-13 sm:w-auto sm:justify-start sm:px-4"
